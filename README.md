...
```
┌─────────────────────────────────────────────────────────┐
│  X E N I T H   AI Agent Orchestrator   Очередь: 0  09:41│
├───────────────────┬─────────────────────────────────────┤
│ Агент    Статус   │ [09:41] XENITH запущен               │
│ agent-1  ● idle   │ [09:41] Vault: .\vault               │
│ agent-2  ⟳ working│ [09:41] Задача a3f2b1 отправлена     │
│                   │ [09:42] Готово a3f2b1 (agent-1, 4.2с)│
├───────────────────┴─────────────────────────────────────┤
│ Последний результат (a3f2b1)                             │
│ Вот реализация функции на Python...                      │
├─────────────────────────────────────────────────────────┤
│ > Введи задачу и нажми Enter  | exit | status | help    │
└─────────────────────────────────────────────────────────┘
```
...
| любой текст | задача для агентов |
